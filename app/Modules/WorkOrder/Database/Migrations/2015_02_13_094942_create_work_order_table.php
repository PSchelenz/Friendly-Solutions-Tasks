        ...
        Schema::table(
            ...
            function (Blueprint $table) use ($columns) {
                ...
                if (!in_array('cancel_reason_type_id', $columns)) {
                    $table->integer('cancel_reason_type_id')->nullable()->unsigned()
                        ->index('cancel_reason_type_id');
                }
                if (!in_array('via_type_id', $columns)) {
                    $table->integer('via_type_id')->nullable()->unsigned()
                        ->index('via_type_id');
                }
                ...
                if (!in_array('shop_address_id', $columns)) {
                    $table->integer('shop_address_id')->nullable()->unsigned()
                ...
                if (!in_array('invoice_status_type_id', $columns)) {
                    $table->integer('invoice_status_type_id')->nullable()->unsigned()
                        ->default(539)->index('invoice_status');
                }
                if (!in_array('bill_status_type_id', $columns)) {
                    $table->integer('bill_status_type_id')->nullable()->unsigned()
                ...
                if (!in_array('quote_status_type_id', $columns)) {
                    $table->integer('quote_status_type_id')->nullable()->unsigned()
                        ->nullable();
                }
                ...
                if (!in_array('project_manager_person_id', $columns)) {
                    $table->integer('project_manager_person_id')->nullable()->unsigned()
                        ->nullable();
                }
                ...
                if (!in_array('requested_by_person_id', $columns)) {
                    $table->integer('requested_by_person_id')->nullable()->unsigned()
                        ->nullable();
                }
                if (!in_array('billing_company_person_id', $columns)) {
                    $table->integer('billing_company_person_id')->nullable()->unsigned()
                        ->nullable();
                }
                ...
                if (!in_array('parts_status_type_id', $columns)) {
                    $table->mediumInteger('parts_status_type_id')->nullable()->unsigned()
                        ->nullable()->default(null);
                }
                if (!in_array('supplier_person_id', $columns)) {
                    $table->mediumInteger('supplier_person_id')->nullable()->unsigned()
                        ->nullable()->default(null);
                }
